...
FILES = ["data/logFile_1.txt", "data/logFile_2.txt", "data/logFile_3.txt"]
...
class TestTimeCalculator:
    ...
    def test_calculate_times_step_type(self):
        ...
        assert_equal(step_dict.lowest_time_file_path, "data/logFile_3.txt")
        assert_equal(step_dict.highest_time, 146.979)
        assert_equal(step_dict.highest_time_file_path, "data/logFile_1.txt")
    ...
    def assert_perturbation(self, perturbation_dict):
        ...
        assert_equal(perturbation_dict.lowest_time_file_path, "data/logFile_3.txt")
        assert_almost_equal(perturbation_dict.highest_time, 50.7186)
        assert_equal(perturbation_dict.highest_time_file_path, "data/logFile_1.txt")
    ...
    def assert_anm(self, anm_dict):
        ...
        assert_equal(anm_dict.lowest_time_file_path, "data/logFile_3.txt")
        assert_almost_equal(anm_dict.highest_time, 21.7559)
        assert_equal(anm_dict.highest_time_file_path, "data/logFile_1.txt")
    ...
    def assert_side_chain(self, side_chain_dict):
        ...
        assert_equal(side_chain_dict.lowest_time_file_path, "data/logFile_2.txt")
        assert_almost_equal(side_chain_dict.highest_time, 53.6631)
        assert_equal(side_chain_dict.highest_time_file_path, "data/logFile_1.txt")
    ...
    def assert_minimization(self, minimization_dict):
        ...
        assert_equal(minimization_dict.lowest_time_file_path, "data/logFile_1.txt")
        assert_almost_equal(minimization_dict.highest_time, 32.5825)
        assert_equal(minimization_dict.highest_time_file_path, "data/logFile_2.txt")
